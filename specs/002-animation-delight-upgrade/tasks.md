...
- [x] T039 [P] [US2] 使用 image2 生成并接入 M22-M27 时间分数批分层资产 (FR-011, FR-018, SC-004)
- [x] T040 [P] [US1] 精修 M22-M27 时间分数批大舞台交互 (FR-002, FR-003, FR-018, SC-005)
- [x] T041 [P] [US2] 使用 image2 生成并接入 M28-M38 图形测量统计批分层资产 (FR-011, FR-018, SC-004)
- [x] T042 [P] [US1] 精修 M28-M38 图形测量统计批大舞台交互 (FR-002, FR-003, FR-018, SC-005)
