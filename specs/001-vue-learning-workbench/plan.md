...
**Constraints**: 无公开注册；两种角色；服务器强制有效期；39 个母题和 117 个子题完整迁移；全程整数；保留现有图片；三种目标视口无溢出；支持减少动态效果

**Scale/Scope**: 38 个知识点、39 个母题、117 个子题、36 组母题图片资产、5 个高质量交互基准模块；最多 10,000 个账号、500 个并发有效 Session
